    ...
    <tr>
      ...
      <td>7</td>
                ...
                <div class="col-lg-12 col-md-12 col-12 mx-auto">
                 ...
                 <div class="discuss_board_body m-5">
                  <div class="row m-3">
                   <div class="col-lg-3 col-md-3 col-2 no-gutters px-sm-0 d-flex justify-content-end">
                    <img src="assets/images/pic-3.jpg" alt="" class="">   
                   </div>
                   <div class="col-lg-8 col-md-8 col-8 no-gutters px-sm-0" >
                       <div class="card">
                        ...
                        <p class="student_msg">
                        Lorem ipsum dolor sit amet, consectetur adipisicing, elit. Maxime quod, quia ullam suscipit minima, eius?
                        </p>
                       </div>    
                   </div>
                  </div>
